...
export default function () {
  ...
  describe('7: اصنع نقاطاً على مستقيم', function () {
    ...
    it('7.2: العدد فقط - زوجي', function () {
      ...
      deepEqual(pArr, [0.5, -0.5, 1.5, -1.5, 2.5, -2.5])
    })
